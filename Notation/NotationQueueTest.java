...
public class NotationQueueTest {
	...
	public NotationQueue<Double> studentQ;
	...
	public void setUp() throws Exception {
		...
		stringQ.enqueue(b);
		stringQ.enqueue(c);
		studentQ = new NotationQueue<Double>();
		studentQ.enqueue(new Double(12.32));
		studentQ.enqueue(new Double(2.23));
		studentQ.enqueue(new Double(2.23));
		studentQ.enqueue(new Double(32.23));
		studentQ.enqueue(new Double(-232.23));
	...
	public void testDequeueStudent() throws QueueUnderflowException {
		...
		assertEquals(studentQ.dequeue(),12.32,0.001);
	...
	public void testEnqueueStudent() throws QueueOverflowException {
		...
		//fail("Not yet implemented");
		int s = studentQ.size();
		studentQ.enqueue(new Double(32.96));
		assertEquals(s+1,studentQ.size(),0.0001);
	}
	...
	public void testToStringStudent() {
		...
		assertTrue("12.322.232.2332.23-232.23".equals(studentQ.toString()));
	}
