...
public class NotationStackTest {
	...
	public  NotationStack<Double> studentS;
	...
	public void setUp() throws Exception {
		...
		studentS = new NotationStack<Double>();
		studentS.push(new Double(32.12));
		studentS.push(new Double(32.12));
		studentS.push(new Double(376.12));
		studentS.push(new Double(62.12));
		studentS.push(new Double(123.12));
		studentS.push(new Double(0.012));
	...
	public void testPopStudent() throws StackUnderflowException, StackOverflowException {
		...
		studentS.push(new Double(13.25532));
		assertEquals(studentS.pop(),13.25532,0.00001);
	}
	...
	public void testPushStudent() throws StackOverflowException, StackUnderflowException {
		//Use the doubleQ for student tests\\
		int s = studentS.size();
		studentS.push(new Double(-32.251));
		assertEquals(studentS.pop(), -32.251,0.00001);
		assertEquals(studentS.size(), s,0.00001);
	}
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertTrue("32.1232.12376.1262.12123.12210.0".equals(studentS.toString()));
