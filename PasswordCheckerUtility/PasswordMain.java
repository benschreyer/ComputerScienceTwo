...
//one line modification made by Ben Schreyer on line 210
			...
			if(selectedFile != null)
			   {
				...
				// ONLY EDIT BY BEN S, I changed it to call getInvalidPasswords() because it said get illegal but was calling getValidPasswords()
