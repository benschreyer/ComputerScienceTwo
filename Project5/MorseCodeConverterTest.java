...
public class MorseCodeConverterTest {
	...
	@Test
	public void testConvertToEnglishString() throws InvalidMorseCodeException {
	...
	//Test for handling of invalid ascii chars in code, Ben Schreyer
	@Test
	public void testConvertToEnglishStringErrors() throws InvalidMorseCodeException {
		String converter1 = MorseCodeConverter.convertToEnglish("--. -abc-- --- -23..42145 -.321.. -.-- . / .-- --- .-. .-.. -.. ");
		assertEquals("goodbye world",converter1);

		String test2="daisy daisy";
		String converter2 = MorseCodeConverter.convertToEnglish("-.. .- .. ... -.--t5ddfgh^$^34 / -.52534. 45345.- 235.. ... -.-- ");
		assertEquals("daisy daisy", converter2);
	}

	@Test
	public void testConvertToEnglishFile() throws FileNotFoundException, InvalidMorseCodeException {
