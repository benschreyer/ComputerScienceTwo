...
public class Graph_STUDENT_Test 
{
	...
	public void setUp() throws Exception 
	{
		 graph = new Graph();
		  ...
		  graph.addEdge(town[4], town[10], 3, "Road_6");
		  ...
		  graph.addEdge(town[2], town[12], 16, "Road_14");
		  graph.addEdge(town[12], town[13], 3, "Road_13");
		  graph.addEdge(town[14], town[8], 7, "Road_15");
		  graph.addEdge(town[14], town[3], 2, "Road_16");
	}
	...
	{
		Road tr = new Road(town[14], town[3],2, "Road_16");
		System.out.println(("Results:  "+(tr == graph.getEdge(town[2], town[11]))) + " "+ graph.getEdge(town[2], town[11]).equals(tr) +" " +tr.equals(graph.getEdge(town[2], town[11])));
		
		assertTrue(graph.getEdge(town[14], town[3]).equals(tr));
	...
	public void testAddEdge() 
	{
		...
		graph.addEdge(town[4], town[5], 12, "Road_18");
	...
	{
		assertEquals(true, graph.containsEdge(town[14], town[3]));
		assertEquals(false, graph.containsEdge(town[10], town[6]));
	}
	...
	public void testContainsVertex() 
	{
		...
		assertEquals(false, graph.containsVertex(new Town("Town_92")));
	}
	...
	public void testRemoveEdge() 
	{
		...
		graph.removeEdge(town[3], town[7], 1, "Road_4");
	...
	public void testVertexSet() 
	{
	  ...
	  public void testTown_1ToTown_14() 
	 {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town_1 via Road_2 to Town_4 4 mi",path.get(0).trim());
			  assertEquals("Town_4 via Road_6 to Town_10 3 mi",path.get(1).trim());
		  }
		  else
	  ...
	  @Test
	  public void testTown5ToTown_4() 
	  {
		  String beginTown = "Town_5", endTown = "Town_4";
		  Town beginIndex=null, endIndex=null;
		  Set<Town> towns = graph.vertexSet();
		  Iterator<Town> iterator = towns.iterator();
		  while(iterator.hasNext())
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertNotNull(path);
			  assertTrue(path.size() > 0);
			  assertEquals("Town_5 via Road_10 to Town_10 5 mi",path.get(0).trim());
			  assertEquals("Town_10 via Road_6 to Town_4 3 mi",path.get(1).trim());
		  }
		  else
			  fail("Town names are not valid");
	  ...
	  public void testTown_4ToTown_11() 
	  {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town_4 via Road_6 to Town_10 3 mi",path.get(0).trim());
			  assertEquals("Town_10 via Road_11 to Town_11 3 mi",path.get(1).trim());
		  }
		  else
			  fail("Town names are not valid");
